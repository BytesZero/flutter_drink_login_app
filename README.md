# flutter_drink_login_app

![](images/img_1.png)
### 📖 项目介绍 📖

这是我的第 2 个 Speed Code 视频，通过此视频你可以学习到如下 `Widget` 的基础或高级用法，更重要的你可以学习到如何将这些 `Widget` 灵活的组合最终实现上面👆的效果。如果觉得有用可以点个 `Star` ，我会更加有动力去录制，谢谢你给我的 Star 🙏 
